...
Namespace Microsoft.CodeAnalysis.VisualBasic.UnitTests
    ...
    Public Class RefStructInterfacesTests
        ...
        Private Shared ReadOnly s_targetFrameworkSupportingByRefLikeGenerics As TargetFramework = TargetFramework.NetLatest
        ...
        Public Sub RuntimeCapability_01()
            ...
            comp = CreateCompilation("", targetFramework:=TargetFramework.NetFramework)
            Assert.False(comp.SupportsRuntimeCapability(RuntimeCapability.ByRefLikeGenerics))
        End Sub
