...
"
            ...
            Dim csCompilation = GetCSharpCompilation(csSource, targetFramework:=TargetFramework.NetLatest).EmitToImageReference(embedInteropTypes:=True)
...
End Class
            ...
            Dim comp1 = CreateCompilation(source1, targetFramework:=TargetFramework.NetLatest, references:={csCompilation})
            comp1.AssertTheseEmitDiagnostics(
<error>
