...
Namespace Microsoft.CodeAnalysis.VisualBasic.UnitTests
    Public Class AttributeTests_UnmanagedCallersOnly
        ...
        Private ReadOnly _csharpReferences As ImmutableArray(Of MetadataReference) = TargetFrameworkUtil.GetReferences(TargetFramework.NetLatest)
...
End Class
            ...
            Dim comp = CreateCompilation(source, references:={reference}, targetFramework:=TargetFramework.NetLatest)
