...
"
            ...
            Dim compilation = CreateCompilation(source, targetFramework:=TargetFramework.NetLatest, options:=TestOptions.ReleaseExe, parseOptions:=TestOptions.RegularLatest)
...
"
            ...
            Dim compilation = CreateCompilation(source, targetFramework:=TargetFramework.NetLatest, options:=TestOptions.ReleaseExe, parseOptions:=TestOptions.Regular16)
            CompileAndVerify(compilation, expectedOutput:="123").VerifyDiagnostics()
        End Sub
...
")
            Dim csCompilation = CreateCSharpCompilation("Program2.Log(5 + 2);", referencedAssemblies:=TargetFrameworkUtil.GetReferences(TargetFramework.NetLatest, {compilation.EmitToImageReference()}), compilationOptions:=New CSharp.CSharpCompilationOptions(OutputKind.ConsoleApplication))
...
End Module
"
            Dim comp1 = CreateCompilation(source, targetFramework:=TargetFramework.NetLatest, parseOptions:=TestOptions.Regular16_9)
...
"
            ...
            Dim compilation = CreateCompilation(source2, references:={ref1}, targetFramework:=TargetFramework.NetLatest, options:=TestOptions.ReleaseExe, parseOptions:=TestOptions.RegularLatest)
...
End Module
"
            Dim compilation = CreateCompilation(source, targetFramework:=TargetFramework.NetLatest, options:=TestOptions.ReleaseExe, parseOptions:=TestOptions.Regular16_9)
...
End Module
"
            Dim compilation = CreateCompilation(Parse(source, "C:\\Program.cs", options:=TestOptions.Regular16_9), targetFramework:=TargetFramework.NetLatest, options:=TestOptions.ReleaseExe)
...
End Module
"
            Dim compilation = CreateCompilation(Parse(source, "C:\\Program.cs", options:=TestOptions.RegularLatest), targetFramework:=TargetFramework.NetLatest, options:=TestOptions.ReleaseExe)
            CompileAndVerify(compilation, expectedOutput:="C:\\Program.cs").VerifyDiagnostics()
        End Sub
...
"
            ...
            Dim compilation = CreateCompilation(source, targetFramework:=TargetFramework.NetLatest, options:=TestOptions.ReleaseDll, parseOptions:=TestOptions.RegularLatest)
            compilation.AssertTheseDiagnostics()
        End Sub
...
End Class
"
            Dim comp1 = CreateCompilation(source, targetFramework:=TargetFramework.NetLatest)
            comp1.VerifyDiagnostics()
            Dim ref1 = comp1.EmitToImageReference()
...
End Class
"
            Dim comp1 = CreateCompilation(source, targetFramework:=TargetFramework.NetLatest, options:=TestOptions.ReleaseDll, parseOptions:=TestOptions.RegularLatest)
            comp1.VerifyDiagnostics()
