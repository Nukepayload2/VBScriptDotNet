...
$gates = @(
    ...
    @{ Name = 'Symbol'; Project = 'Compilers\VisualBasicSymbolTest\Microsoft.CodeAnalysis.VisualBasic.Symbol.UnitTests.vbproj'; Total = 3399; Passed = 3375; Skipped = 24; Failed = 0 }
    @{ Name = 'Semantic'; Project = 'Compilers\VisualBasicSemanticTest\Microsoft.CodeAnalysis.VisualBasic.Semantic.UnitTests.vbproj'; Total = 5747; Passed = 5643; Skipped = 104; Failed = 0 }
