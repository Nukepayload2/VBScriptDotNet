...
$gates = @(
    ...
    @{ Name = 'CommandLine'; Project = 'Compilers\VisualBasicCommandLineTest\Microsoft.CodeAnalysis.VisualBasic.CommandLine.UnitTests.vbproj'; Total = 475; Passed = 462; Skipped = 6; Failed = 7 }
)
