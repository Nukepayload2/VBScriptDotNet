...
Public Class NuGetRestoreCoordinatorTests
    ...
    Private Const ManagedAssetsJson As String = "{""packageFolders"":[""C:/nuget/packages/""],""libraries"":{""Contoso.Lib/2.0.0"":{""type"":""package"",""path"":""contoso.lib/2.0.0""}},""targets"":{ "".NETCoreApp,Version=v10.0"":{""Contoso.Lib/2.0.0"":{""type"":""package"",""compile"":{""lib/net10.0/Contoso.Lib.dll"":{}},""runtime"":{""lib/net10.0/Contoso.Lib.dll"":{}}}}}}"

    Private Const Net48NativeAssetsJson As String = "{""packageFolders"":[""C:/nuget/packages/""],""libraries"":{""contoso.native/1.0.0"":{""type"":""package"",""path"":""contoso.native/1.0.0""}},""targets"":{ "".NETFramework,Version=v4.8"":{""contoso.native/1.0.0"":{""type"":""package"",""compile"":{""lib/net48/Contoso.Native.dll"":{}},""runtime"":{""lib/net48/Contoso.Native.dll"":{}},""runtimeTargets"":{""runtimes/win-x64/native/e_sqlite3.dll"":{""rid"":""win-x64"",""assetType"":""native""}}}}}}"
    ...
    Private Const NativeForOtherRidAssetsJson As String = "{""packageFolders"":[""C:/nuget/packages/""],""libraries"":{""Contoso.Native/1.0.0"":{""type"":""package"",""path"":""contoso.native/1.0.0""}},""targets"":{ "".NETCoreApp,Version=v10.0"":{""Contoso.Native/1.0.0"":{""type"":""package"",""compile"":{""lib/net10.0/Contoso.Native.dll"":{}},""runtime"":{""lib/net10.0/Contoso.Native.dll"":{}},""runtimeTargets"":{""runtimes/win7-x86/native/e_sqlite3.dll"":{""rid"":""win7-x86"",""assetType"":""native""}}}}}}"
